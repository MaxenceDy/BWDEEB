...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 19 Avril 2017 à 14:33
...
SELECT Nom_Photo AS Image, Moderation, Id_Photo AS ID FROM photo ORDER BY Moderation$$
...
(1, 'Geekobowling', '2017-01-18 20:00:00', 'Venez affronter d\'autre promo d\'informatique à une super soirée bowling, color-bowl de Reims. Venez nombreux', 15, 'Images/Activites/geekobowling.01.2017.png', 2),
(2, 'LAN#7', '2017-04-07 18:00:00', 'EXIA LAN#7, Venez vous affontez sur nos tournois pour rencontrés des teams de votre niveaux sur Counter Strike : Global Offensive, ou League Of Legend, ou encore Overwatch et tenter de remporter les différents lots :\r\nCS:GO	LOL	OW\r\n750	500	240\r\n500	350	180\r\n300 	150	60', 15, 'Images/Activites/LAN.04.2017.jpg', 2),
...
(10, 'Sortie Cinéma', '2017-04-19 16:00:00', 'Sortie au cinéma voir Ghost in the Shell', 8, 'Images/Activites/gits.jpg', 1);
...
(1, 'Super belle ces piste!!!', '2017-01-25', 4, 5),
(2, 'Qui lance sur la photo?', '2017-01-19', 3, 4),
(3, 'colorbowl genial', '2017-04-20', 2, 5),
(4, 'colorbowl c\'est genial', '2017-04-20', 2, 5),
(5, 'colorbowl c\'est genial', '2017-04-20', 2, 5),
(6, 'colorbowl c\'est mieux que bien', '2017-04-20', 2, 5),
(7, 'colorbowl super soirée garantie', '2017-04-20', 2, 5);
...
(2, 'des spinneur fluos', 4),
(3, 'une suggestion', 4),
(4, 'une suggestion', 4),
(5, 'une suggestion', 4),
(6, 'je veux des bonbons', 4),
(7, 'pouet', 4);
...
--
ALTER TABLE `commentaire_photo`
  MODIFY `Id_Commentaire_P` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
